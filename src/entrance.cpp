...
void CacheConn::writevClient( LinkListNode* data, const unsigned int& blockSize, const unsigned int& offset, const unsigned int&  len, const int& index )
{
