...
private:
    ...
    shared_ptr<ClientRequest> clientData; //存储客户端的协议
...
private:
    ...
    void writevClient( LinkListNode* data, const unsigned int& blockSize, const unsigned int& offset, const unsigned int&  len, const int& index );
